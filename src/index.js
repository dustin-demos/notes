...
const render = props => {
  return html.html({ lang: 'en' }, [
    ...
    link({ rel: 'icon', href: '/onclick-notes/cache/favicon.svg' }),
    PreloadFont({ href: '/onclick-notes/fonts/Inter-3.18/Inter-roman.var.woff2' }),
    PreloadFont({ href: '/onclick-notes/fonts/Inter-3.18/Inter-italic.var.woff2' }),
    PreloadFont({ href: '/onclick-notes/fonts/SourceCodePro-1.018/SourceCodePro-roman.var.otf' }),
    PreloadFont({ href: '/onclick-notes/fonts/SourceCodePro-1.018/SourceCodePro-italic.var.otf' }),
    styles,
    body([
